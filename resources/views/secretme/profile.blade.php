...
<head>
    ...
    <script src="{{ asset('js/secretme.js') }}"></script>
        ...
        <div class="main-container">
            ...
            <div class="message-block">
                ...
                <div class="share-link-flex">
                    <textarea name="" id="" cols="30" rows="10">{{url()->current()}}</textarea>
                    <button class="btn btn-outline-Secondary" onclick="copyToClipboard('{{ url()->current() }}')">
                        <i class="bi bi-clipboard"></i>
                    </button>
                </div>
                <p class="ms-3 copy-text">
                    ...
                    <div class="main-message-box mb-2">
                        ...
                        @foreach ($message->comments as $comment)
                            <div class="comments">
                                ...
                                <div class="btn-edit">
                                    <button class="" data-toggle="modal" data-target="#editData{{ $comment->id }}">
                                        <i class="bi bi-pencil-square"></i>
                                    </button>
                                </div>
                            </div>
                            <div class="modal fade mt-5" id="editData{{ $comment->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content" style="border:0ch;">
                                        ...
                                        <div class="modal-body">
                                            <form method="POST" action="{{ route('comments.update', $comment->id) }}">
                                                ...
                                                <div class="form-group mb-3">
                                                    {{-- <label class="mb-3" for="comment">Edit</label> --}}
                                                    <textarea class="form-control" id="comment" name="comment" rows="2">{{ $comment->comment }}</textarea>
